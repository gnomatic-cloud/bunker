/*! For license information please see chunk.256.d91562e6eb8f60f96d29.js.LICENSE.txt */
(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[256],{2256:(e,t,n)=>{var r
...
function $(e,t,n){var r=Q.length?Q.slice(-1)[0]:null,i=null!==r?[r.name,e].join(" > "):e,o=r?r.suiteReport:z,s=null!==r&&r.skip||n.skip,a=null!==r&&r.todo||n.todo,u={}
...
return r&&r.childModules.push(l),H.modules.push(l),l}function G(e,t,n){var r=t[n]
"function"==typeof r&&e[n].push(r),delete t[n]}function Y(e,t){return function(n){H.currentModule!==e&&E.warn("The `"+t+"` hook was called inside the wrong module (`"+H.currentModule.name+"`). Instead, use hooks provided by the callback to the containing module (`"+e.name+"`). This will become an error in QUnit 3.0."),e.hooks[t].push(n)}}function W(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{}
"function"===A(t)&&(n=t,t=void 0)
var i=$(e,t,r),o=i.testEnvironment,s=i.hooks
G(s,o,"before"),G(s,o,"beforeEach"),G(s,o,"afterEach"),G(s,o,"after")
var a={before:Y(i,"before"),beforeEach:Y(i,"beforeEach"),afterEach:Y(i,"afterEach"),after:Y(i,"after")},u=H.currentModule
if(H.currentModule=i,"function"===A(n)){Q.push(i)
try{var l=n.call(i.testEnvironment,a)
null!=l&&"function"===A(l.then)&&E.warn("Returning a promise from a module callback is not supported. Instead, use hooks for async behavior. This will become an error in QUnit 3.0.")}finally{Q.pop(),H.currentModule=i.parentModule||u}}}var J=!1
function V(e,t,n){var r
W(e,t,n,{ignored:J&&(r=H.modules.filter((function(e){return!e.ignored})).map((function(e){return e.moduleId})),!Q.some((function(e){return r.includes(e.moduleId)})))})}V.only=function(){J||(H.modules.length=0,H.queue.length=0,H.currentModule.ignored=!0),J=!0,W.apply(void 0,arguments)},V.skip=function(e,t,n){J||W(e,t,n,{skip:!0})},V.todo=function(e,t,n){J||W(e,t,n,{todo:!0})}
var Z=Object.create(null),K=["error","runStart","suiteStart","testStart","assertion","testEnd","suiteEnd","runEnd"]
function X(e,t){if("string"!==A(e))throw new TypeError("eventName must be a string when emitting an event")
for(var n=Z[e],r=n?f(n):[],i=0;i<r.length;i++)r[i](t)}var ee="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},te={exports:{}}
...
de.finished=!0,X("runEnd",z.end(!0)),re("done",{passed:r,failed:H.stats.bad,total:H.stats.all,runtime:n}).then((function(){if(t&&0===H.stats.bad)for(var e=t.length-1;e>=0;e--){var n=t.key(e)
...
j.measure("QUnit Test: ".concat(t),"qunit_test_start","qunit_test_end")}return _(this.start(),{runtime:this.getRuntime(),status:this.getStatus(),errors:this.getFailedAssertions(),assertions:this.getAssertions()})}},{key:"pushAssertion",value:function(e){this.assertions.push(e)}},{key:"getRuntime",value:function(){return this._endTime-this._startTime}},{key:"getStatus",value:function(){return this.skipped?"skipped":(this.getFailedAssertions().length>0?this.todo:!this.todo)?this.todo?"todo":"passed":"failed"}},{key:"getFailedAssertions",value:function(){return this.assertions.filter((function(e){return!e.passed}))}},{key:"getAssertions",value:function(){return this.assertions.slice()}},{key:"slimAssertions",value:function(){this.assertions=this.assertions.map((function(e){return delete e.actual,delete e.expected,e}))}}]),e}()
...
this.testId=L(this.module.name,this.testName),this.module.tests.push({name:this.testName,testId:this.testId,skip:!!this.skip}),this.skip?(this.callback=function(){},this.async=!1,this.expected=0):this.assert=new qe(this)}}function ge(){if(!H.current)throw new Error("pushFailure() assertion outside test context, in "+se(2))
var e=H.current
...
H.pollution.push(e)}}pe.count=0,pe.prototype={get stack(){return oe(this.errorForStack,2)},before:function(){var e=this,t=this.module
return function(e){for(var t=e,n=[];t&&0===t.testsRun;)n.push(t),t=t.parentModule
return n.reverse()}(t).reduce((function(e,t){return e.then((function(){return t.stats={all:0,bad:0,started:N()},X("suiteStart",t.suiteReport.start(!0)),re("moduleStart",{name:t.name,tests:t.tests})}))}),ne.resolve([])).then((function(){return H.current=e,e.testEnvironment=_({},t.testEnvironment),e.started=N(),X("testStart",e.testReport.start(!0)),re("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){H.pollution||me()}))}))},run:function(){if(H.current=this,this.callbackStarted=N(),H.notrycatch)e(this)
...
n.hooks={},t.push.apply(t,f(n.childModules))}return X("suiteEnd",e.suiteReport.end(!0)),re("moduleDone",{name:e.name,tests:e.tests,failed:e.stats.bad,passed:e.stats.all-e.stats.bad,total:e.stats.all,runtime:N()-e.stats.started})}(t)}))}),ne.resolve([]))}})).then((function(){H.current=void 0}))},preserveTestEnvironment:function(){this.preserveEnvironment&&(this.module.testEnvironment=this.testEnvironment,this.testEnvironment=_({},this.module.testEnvironment))},queue:function(){var e=this
...
i.remaining--,0===i.remaining&&e.pauses.delete(r),Ce(e)}}return e.pauses.set(r,i),b&&("number"==typeof e.timeout?n=e.timeout:"number"==typeof H.testTimeout&&(n=H.testTimeout),"number"==typeof n&&n>0&&(H.timeoutHandler=function(t){return function(){H.timeout=null,i.cancelled=!0,e.pauses.delete(r),e.pushFailure("Test took longer than ".concat(t,"ms; test timed out."),se(2)),Ce(e)}},y(H.timeout),H.timeout=b(H.timeoutHandler(n),n))),o}function Te(e){e.pauses.forEach((function(e){e.cancelled=!0})),e.pauses.clear(),Ce(e)}function Ce(e){e.pauses.size>0||(b?(y(H.timeout),H.timeout=b((function(){e.pauses.size>0||(y(H.timeout),H.timeout=null,et())}))):et())}function Ne(e){for(var t=[].concat(e.tests),n=f(e.childModules);n.length;){var r=n.shift()
t.push.apply(t,r.tests),n.push.apply(n,f(r.childModules))}return t}function Se(e){return e.testsRun+e.testsIgnored===Ne(e).length}function je(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}_(ke,{todo:function(e,t){be({testName:e,callback:t,todo:!0})},skip:function(e){be({testName:e,skip:!0})},only:function(e,t){ye({testName:e,callback:t})},each:function(e,t,n){xe(t,(function(t,r){be({testName:we(e,r),callback:n,withData:!0,data:t})}))}}),ke.todo.each=function(e,t,n){xe(t,(function(t,r){be({testName:we(e,r),callback:n,todo:!0,withData:!0,data:t})}))},ke.skip.each=function(e,t){xe(t,(function(t,n){be({testName:we(e,n),skip:!0})}))},ke.only.each=function(e,t,n){xe(t,(function(t,r){ye({testName:we(e,r),callback:n,withData:!0,data:t})}))}
var qe=function(){function e(t){a(this,e),this.test=t}return l(e,[{key:"timeout",value:function(e){if("number"!=typeof e)throw new Error("You must pass a number as the duration to assert.timeout")
var t
...
return[r,t,n]}qe.prototype.raises=qe.prototype.throws
...
break
default:t=e}return t}var $e={console:Le,tap:function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
function Ge(e){return function(t){H.globalHooks[e]||(H.globalHooks[e]=[]),H.globalHooks[e].push(t)}}var Ye={beforeEach:Ge("beforeEach"),afterEach:Ge("afterEach")}
function We(e){H.current?H.current.assert.pushResult({result:!1,message:"global failure: ".concat(P(e)),source:e&&e.stack||se(2)}):(z.globalFailureCount++,H.stats.bad++,H.stats.all++,X("error",e))}var Je={}
H.currentModule.suiteReport=z
var Ve=!1,Ze=!1
function Ke(){Ze=!0,b?b((function(){et()})):et()}function Xe(){H.blocking=!1,de.advance()}function et(){if(H.started)Xe()
...
X("runStart",z.start(!0)),re("begin",{totalTests:pe.count,modules:t}).then(Xe)}}Je.isLocal=g&&g.location&&"file:"===g.location.protocol,Je.version="2.18.0",_(Je,{config:H,dump:F,equiv:U,reporters:$e,hooks:Ye,is:O,objectType:A,on:function(e,t){if("string"!==A(e))throw new TypeError("eventName must be a string when registering a listener")
if(!M(e,K)){var n=K.join(", ")
...
Z[e]||(Z[e]=[]),M(t,Z[e])||Z[e].push(t)},onError:function(e){if(E.warn("QUnit.onError is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),H.current&&H.current.ignoreGlobalErrors)return!0
var t=new Error(e.message)
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,We(t),!1},onUncaughtException:We,pushFailure:ge,assert:qe.prototype,module:V,test:ke,todo:ke.todo,skip:ke.skip,only:ke.only,start:function(e){if(H.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=Ve
if(Ve=!0,Ze)throw new Error("Called start() while test already started running")
...
if(!H.pageLoaded)return H.autostart=!0,void(k||Je.load())
Ke()},onUnhandledRejection:function(e){E.warn("QUnit.onUnhandledRejection is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),We(e)},extend:function(){E.warn("QUnit.extend is deprecated and will be removed in QUnit 3.0. Please use Object.assign instead.")
for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
return _.apply(this,t)},load:function(){H.pageLoaded=!0,_(H,{started:0,updateRate:1e3,autostart:!0,filter:""},!0),Ze||(H.blocking=!1,H.autostart&&Ke())},stack:function(e){return se(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
...
"undefined"===A(H.callbacks[o])&&(H.callbacks[o]=[]),e[o]=n(o)}}(Je),function(i){var o=!1
if(g&&k){if(g.QUnit&&g.QUnit.version)throw new Error("QUnit has already been defined.")
g.QUnit=i,o=!0}e&&e.exports&&(e.exports=i,e.exports.QUnit=i,o=!0),t&&(t.QUnit=i,o=!0),void 0===(r=function(){return i}.call(t,n,t,e))||(e.exports=r),i.config.autostart=!1,o=!0,m&&m.WorkerGlobalScope&&m instanceof m.WorkerGlobalScope&&(m.QUnit=i,o=!0),o||(p.QUnit=i)}(Je),function(){if(g&&k){var e=Je.config,t=Object.prototype.hasOwnProperty
Je.begin((function(){if(!t.call(e,"fixture")){var n=k.getElementById("qunit-fixture")
n&&(e.fixture=n.cloneNode(!0))}})),Je.testStart((function(){if(null!=e.fixture){var t=k.getElementById("qunit-fixture")
...
return s}()
Je.urlParams=t,Je.config.moduleId=[].concat(t.moduleId||[]),Je.config.testId=[].concat(t.testId||[]),Je.config.module=t.module,Je.config.filter=t.filter,!0===t.seed?Je.config.seed=Math.random().toString(36).slice(2):t.seed&&(Je.config.seed=t.seed),Je.config.urlConfig.push({id:"hidepassed",label:"Hide passed tests",tooltip:"Only show tests and assertions that fail. Stored as query-strings."},{id:"noglobals",label:"Check for Globals",tooltip:"Enabling this will test if any test introduces new properties on the global object (`window` in Browsers). Stored as query-strings."},{id:"notrycatch",label:"No try-catch",tooltip:"Enabling this will run tests outside of a try-catch block. Makes debugging exceptions in IE reasonable. Stored as query-strings."}),Je.begin((function(){var e,n,r=Je.config.urlConfig
for(e=0;e<r.length;e++)"string"!=typeof(n=Je.config.urlConfig[e])&&(n=n.id),void 0===Je.config[n]&&(Je.config[n]=t[n])}))}function n(e){return decodeURIComponent(e.replace(/\+/g,"%20"))}}()
var tt={exports:{}}
!function(e){var t,n
...
var s=Date.now()
if(i&&i.keys)for(var d=i.scoreFn||l,E=i.keys,T=E.length;m>=0;--m){for(var C=n[m],N=new Array(T),S=T-1;S>=0;--S)(M=c(C,q=E[S]))?(f(M)||(M=p.getPrepared(M)),N[S]=y(t,M,h)):N[S]=null
N.obj=C
var j=d(N)
if(null!==j&&!(j<v)&&(N.score=j,k<b?(g.add(N),++k):(++w,j>g.peek().score&&g.replaceTop(N)),m%1e3==0&&Date.now()-s>=10))return void(e?setImmediate(x):setTimeout(x))}else if(i&&i.key){for(var q=i.key;m>=0;--m)if((M=c(C=n[m],q))&&(f(M)||(M=p.getPrepared(M)),null!==(I=y(t,M,h))&&!(I.score<v)&&(I={target:I.target,_targetLowerCodes:null,_nextBeginningIndexes:null,score:I.score,indexes:I.indexes,obj:C},k<b?(g.add(I),++k):(++w,I.score>g.peek().score&&g.replaceTop(I)),m%1e3==0&&Date.now()-s>=10)))return void(e?setImmediate(x):setTimeout(x))}else for(;m>=0;--m){var M,I
...
return p}()},e.exports?e.exports=n():t.fuzzysort=n()}(tt)
var nt=tt.exports,rt={failedTests:[],defined:0,completed:0}
function it(e){return e?(e+="").replace(/['"<>&]/g,(function(e){switch(e){case"'":return"&#039;"
case'"':return"&quot;"
case"<":return"&lt;"
case">":return"&gt;"
case"&":return"&amp;"}})):""}!function(){if(g&&k){var e=Je.config,t=[],n=!1,r=Object.prototype.hasOwnProperty,i=C({filter:void 0,module:void 0,moduleId:void 0,testId:void 0})
Je.on("runStart",(function(e){rt.defined=e.testCounts.total})),Je.begin((function(){var t,n,o,s,a,u,d,h,v,C,j;(u=y("qunit"))&&(u.setAttribute("role","main"),u.innerHTML="<h1 id='qunit-header'>"+it(k.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(t=Je.config.testId)||t.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+it(t.join(", "))+" <a id='qunit-clearFilter' href='"+it(i)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(n=y("qunit-header"))&&(n.innerHTML="<a href='"+it(i)+"'>"+n.innerHTML+"</a> "),(o=y("qunit-banner"))&&(o.className=""),C=y("qunit-tests"),(j=y("qunit-testresult"))&&j.parentNode.removeChild(j),C&&(C.innerHTML="",(j=k.createElement("p")).id="qunit-testresult",j.className="result",C.parentNode.insertBefore(j,C),j.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',h=y("qunit-testresult-controls")),h&&h.appendChild(((v=k.createElement("button")).id="qunit-abort-tests-button",v.innerHTML="Abort",l(v,"click",x),v)),(s=y("qunit-userAgent"))&&(s.innerHTML="",s.appendChild(k.createTextNode("QUnit "+Je.version+"; "+w.userAgent))),(a=y("qunit-testrunner-toolbar"))&&(a.appendChild(((d=k.createElement("span")).innerHTML=function(){var t,n,i,o,s,a=!1,u=e.urlConfig,l=""
for(t=0;t<u.length;t++)if("string"==typeof(i=e.urlConfig[t])&&(i={id:i,label:i}),o=it(i.id),s=it(i.tooltip),i.value&&"string"!=typeof i.value){if(l+="<label for='qunit-urlconfig-"+o+"' title='"+s+"'>"+i.label+": </label><select id='qunit-urlconfig-"+o+"' name='"+o+"' title='"+s+"'><option></option>",Array.isArray(i.value))for(n=0;n<i.value.length;n++)l+="<option value='"+(o=it(i.value[n]))+"'"+(e[i.id]===i.value[n]?(a=!0)&&" selected='selected'":"")+">"+o+"</option>"
else for(n in i.value)r.call(i.value,n)&&(l+="<option value='"+it(n)+"'"+(e[i.id]===n?(a=!0)&&" selected='selected'":"")+">"+it(i.value[n])+"</option>")
e[i.id]&&!a&&(l+="<option value='"+(o=it(e[i.id]))+"' selected='selected' disabled='disabled'>"+o+"</option>"),l+="</select>"}else l+="<label for='qunit-urlconfig-"+o+"' title='"+s+"'><input id='qunit-urlconfig-"+o+"' name='"+o+"' type='checkbox'"+(i.value?" value='"+it(i.value)+"'":"")+(e[i.id]?" checked='checked'":"")+" title='"+s+"' />"+it(i.label)+"</label>"
...
t.style.display=n.style.display=y?"":"none",s.placeholder=u.join(", ")||p.parentNode.textContent,s.title="Type to filter list. Current selection:\n"+(u.join("\n")||p.parentNode.textContent)}return s.id="qunit-modulefilter-search",s.autocomplete="off",l(s,"input",x),l(s,"input",w),l(s,"focus",w),l(s,"click",w),e.modules.forEach((function(e){return e.namePrepared=nt.prepare(e.name)})),o.id="qunit-modulefilter-search-container",o.innerHTML="Module: ",o.appendChild(s),f.textContent="Apply",f.style.display="none",d.textContent="Reset",d.type="reset",d.style.display="none",p.type="checkbox",p.checked=0===e.moduleId.length,h.className="clickable",e.moduleId.length&&(h.className="checked"),h.appendChild(p),h.appendChild(k.createTextNode("All modules")),u.id="qunit-modulefilter-actions",u.appendChild(f),u.appendChild(d),u.appendChild(h),t=u.firstChild,n=t.nextSibling,l(t,"click",N),v.id="qunit-modulefilter-dropdown-list",v.innerHTML=S(e.modules),a.id="qunit-modulefilter-dropdown",a.style.display="none",a.appendChild(u),a.appendChild(v),l(a,"change",T),T(),i.id="qunit-modulefilter",i.appendChild(o),i.appendChild(a),l(i,"submit",E),l(i,"reset",(function(){g.setTimeout(T)})),i}()),o}()),a.appendChild(k.createElement("div")).className="clearfix")})),Je.on("runEnd",(function(t){var n,r,i,o=y("qunit-banner"),s=y("qunit-tests"),a=y("qunit-abort-tests-button"),u=e.stats.all-e.stats.bad,l=[t.testCounts.total," tests completed in ",t.runtime," milliseconds, with ",t.testCounts.failed," failed, ",t.testCounts.skipped," skipped, and ",t.testCounts.todo," todo.<br />","<span class='passed'>",u,"</span> assertions of <span class='total'>",e.stats.all,"</span> passed, <span class='failed'>",e.stats.bad,"</span> failed.",q(rt.failedTests)].join("")
if(a&&a.disabled){l="Tests aborted after "+t.runtime+" milliseconds."
for(var c=0;c<s.children.length;c++)""!==(n=s.children[c]).className&&"running"!==n.className||(n.className="aborted",i=n.getElementsByTagName("ol")[0],(r=k.createElement("li")).className="fail",r.innerHTML="Test aborted.",i.appendChild(r))}!o||a&&!1!==a.disabled||(o.className="failed"===t.status?"qunit-fail":"qunit-pass"),a&&a.parentNode.removeChild(a),s&&(y("qunit-testresult-display").innerHTML=l),e.altertitle&&k.title&&(k.title=["failed"===t.status?"✖":"✔",k.title.replace(/^[\u2714\u2716] /i,"")].join(" ")),e.scrolltop&&g.scrollTo&&g.scrollTo(0,0)})),Je.testStart((function(e){var t,n
j(e.name,e.testId,e.module),(t=y("qunit-testresult-display"))&&(p(t,"running"),n=Je.config.reorder&&e.previousFailure,t.innerHTML=[I(rt),n?"Rerunning previously failed test: <br />":"Running: ",M(e.name,e.module),q(rt.failedTests)].join(""))})),Je.log((function(e){var t,n,i,o,s,a,u=!1,l=y("qunit-test-output-"+e.testId)
l&&(i="<span class='test-message'>"+(i=it(e.message)||(e.result?"okay":"failed"))+"</span>",i+="<span class='runtime'>@ "+e.runtime+" ms</span>",!e.result&&r.call(e,"expected")?(o=e.negative?"NOT "+Je.dump.parse(e.expected):Je.dump.parse(e.expected),s=Je.dump.parse(e.actual),i+="<table><tr class='test-expected'><th>Expected: </th><td><pre>"+it(o)+"</pre></td></tr>",s!==o?(i+="<tr class='test-actual'><th>Result: </th><td><pre>"+it(s)+"</pre></td></tr>","number"==typeof e.actual&&"number"==typeof e.expected?isNaN(e.actual)||isNaN(e.expected)||(u=!0,a=((a=e.actual-e.expected)>0?"+":"")+a):"boolean"!=typeof e.actual&&"boolean"!=typeof e.expected&&(u=R(a=Je.diff(o,s)).length!==R(o).length+R(s).length),u&&(i+="<tr class='test-diff'><th>Diff: </th><td><pre>"+a+"</pre></td></tr>")):-1!==o.indexOf("[object Array]")||-1!==o.indexOf("[object Object]")?i+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the depth of object is more than current max depth ("+Je.config.maxDepth+").<p>Hint: Use <code>QUnit.dump.maxDepth</code> to  run with a higher max depth or <a href='"+it(C({maxDepth:-1}))+"'>Rerun</a> without max depth.</p></td></tr>":i+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the expected and actual results have an equivalent serialization</td></tr>",e.source&&(i+="<tr class='test-source'><th>Source: </th><td><pre>"+it(e.source)+"</pre></td></tr>"),i+="</table>"):!e.result&&e.source&&(i+="<table><tr class='test-source'><th>Source: </th><td><pre>"+it(e.source)+"</pre></td></tr></table>"),t=l.getElementsByTagName("ol")[0],(n=k.createElement("li")).className=e.result?"pass":"fail",n.innerHTML=i,t.appendChild(n))})),Je.testDone((function(r){var i,o,s,a,u,c,f,d,h,g=y("qunit-tests"),v=y("qunit-test-output-"+r.testId)
...
if(w?p(s,"qunit-collapsed"):(rt.failedTests.push(r.testId),e.collapse&&(n?p(s,"qunit-collapsed"):n=!0)),f=c?"<b class='failed'>"+c+"</b>, <b class='passed'>"+u+"</b>, ":"",(i=v.firstChild).innerHTML+=" <b class='counts'>("+f+r.assertions.length+")</b>",rt.completed++,r.skipped)v.className="skipped",(d=k.createElement("em")).className="qunit-skipped-label",d.innerHTML="skipped",v.insertBefore(d,i)
else{if(l(i,"click",(function(){m(s,"qunit-collapsed")})),v.className=w?"pass":"fail",r.todo){var x=k.createElement("em")
x.className="qunit-todo-label",x.innerHTML="todo",v.className+=" todo",v.insertBefore(x,i)}(o=k.createElement("span")).className="runtime",o.innerHTML=r.runtime+" ms",v.insertBefore(o,s)}r.source&&((h=k.createElement("p")).innerHTML="<strong>Source: </strong>"+it(r.source),p(h,"qunit-source"),w&&p(h,"qunit-collapsed"),l(i,"click",(function(){m(h,"qunit-collapsed")})),v.appendChild(h)),e.hidepassed&&("passed"===a||r.skipped)&&(t.push(v),g.removeChild(v))}})),Je.on("error",(function(e){var t=j("global failure")
if(t){var n=it(P(e))
n="<span class='test-message'>"+n+"</span>",e&&e.stack&&(n+="<table><tr class='test-source'><th>Source: </th><td><pre>"+it(e.stack)+"</pre></td></tr></table>")
...
s&&v.warn("Support for PhantomJS is deprecated and will be removed in QUnit 3.0."),s||"complete"!==k.readyState?l(g,"load",Je.load):Je.load()
var a=g.onerror
...
for(t in e=_(_({},Je.urlParams),e))if(r.call(e,t)&&void 0!==e[t])for(n=[].concat(e[t]),i=0;i<n.length;i++)o+=encodeURIComponent(t),!0!==n[i]&&(o+="="+encodeURIComponent(n[i])),o+="&"
...
for(n=0;n<t.length;n++)""!==t[n].name&&(i+="<li><label class='clickable"+((r=e.moduleId.indexOf(t[n].moduleId)>-1)?" checked":"")+"'><input type='checkbox' value='"+t[n].moduleId+"'"+(r?" checked='checked'":"")+" />"+it(t[n].name)+"</label></li>")
return i}function j(e,t,n){var r,i,o,s,a=y("qunit-tests")
if(a)return(r=k.createElement("strong")).innerHTML=M(e,n),(o=k.createElement("li")).appendChild(r),void 0!==t&&((i=k.createElement("a")).innerHTML="Rerun",i.href=C({testId:t}),o.id="qunit-test-output-"+t,o.appendChild(i)),(s=k.createElement("ol")).className="qunit-assert-list",o.appendChild(s),a.appendChild(o),o}function q(e){return 0===e.length?"":["<br /><a href='"+it(C({testId:e}))+"'>",1===e.length?"Rerun 1 failed test":"Rerun "+e.length+" failed tests","</a>"].join("")}function M(e,t){var n=""
return t&&(n="<span class='module-name'>"+it(t)+"</span>: "),n+"<span class='test-name'>"+it(e)+"</span>"}function I(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function R(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}(),Je.diff=function(){function e(){}var t=-1,n=Object.prototype.hasOwnProperty
...
for(i=0;i<e.length;i++)switch(n=e[i][0],r=e[i][1],n){case 1:o[i]="<ins>"+it(r)+"</ins>"
break
case t:o[i]="<del>"+it(r)+"</del>"
break
case 0:o[i]="<span>"+it(r)+"</span>"}return o.join("")},e.prototype.diffCommonPrefix=function(e,t){var n,r,i,o
