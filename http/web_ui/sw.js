!function(){"use strict"
self.CACHE_BUSTER="1699989141325|0.2395924576347097",self.addEventListener("install",(function(e){return self.skipWaiting()})),self.addEventListener("message",(function(e){if("skipWaiting"===e.data)return self.skipWaiting()})),self.addEventListener("activate",(function(e){return self.clients.claim()}))
...
return function(e,t){return!!t.find((t=>t.test(decodeURI(e))))}(n.url,e)&&"GET"===n.method?t.respondWith(function(e){let t=new Headers(e.headers)
